...
RSpec.describe DatasetsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new dataset" do

        post :create, params: {dataset: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(dataset_url(Dataset.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new dataset" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the dataset" do
        dataset = Dataset.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the dataset" do
        dataset = Dataset.create! valid_attributes
